        ...
        <div class="content-wrapper">
            ...
            <div class="navigation">
                ...
                <div class="navigation-menu-body">
                    <ul>
                        <li>
                            <a @if(request()->segment(2)== 'dashboard') class="active" @endif href="/dashboard">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a @if(request()->segment(2) == 'customer') class="active"
                                        @endif href="/customer">Create</a>
                                </li>

                                <li>
                                    <a @if(request()->segment(2) == 'customerList') class="active"
                                        @endif href="/customerList">List</a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="nav-link-icon">
                                    ...
                                    <ul>
                                        <li>
                                            <a @if(request()->segment(2) == 'countryList') class="active"
                                                @endif href="/countryList">List</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a @if(request()->segment(2) == 'customerOrder') class="active"
                                        @endif href="/customerOrder">Create</a>
                                </li>
                                <li>
                                    <a @if(request()->segment(2) == 'orderList') class="active"
